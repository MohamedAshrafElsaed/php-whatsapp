    ...
    <AppLayout>
        ...
        <div class="mx-auto max-w-2xl space-y-6 p-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold tracking-tight">Add Contact</h1>
            ...
            <div class="rounded-lg border bg-muted/50 p-4">
                <h3 class="mb-2 font-semibold">Tips for adding contacts:</h3>
                <ul class="space-y-1 text-sm text-muted-foreground">
                    <li>• Phone number must include country code (e.g., +1, +44, +91)</li>
