...
/**
 * Submit form to create segment
 */
const submit = (): void => {
    form.post('/contacts/segments');
};
</script>

<template>
    <AppLayout>
        <Head :title="t('segments.create')" />
            ...
            <div class="mx-auto max-w-4xl space-y-4 p-4 sm:space-y-6 sm:p-6 lg:p-8">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                        <Link href="/contacts/segments" class="flex-1 sm:flex-none">
                        ...
                        >
                            ...
                            {{ form.processing ? t('segments.creating') : t('segments.create_segment') }}
                        </Button>
                    </div>
                </form>
            </div>
