...
// Function to format variable for display
const formatVariable = (variable: string) => {
    return `{{${variable}}}`;
};

watch(() => form.import_id, (newImportId) => {
    if (newImportId) {
...
const insertVariable = (variable: string) => {
    ...
    if (textarea) {
        ...
        form.message_template = text.substring(0, start) + variableText + text.substring(end);
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-950">
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                >
                                    <option :value="null">Choose an import...</option>
                                    <option
                                        v-for="importItem in imports"
                                        :key="importItem.id"
                                        :value="importItem.id"
                                    >
                                        {{ importItem.filename }} ({{ importItem.valid_rows }} contacts)
                                    </option>
                                </select>
                                <p v-if="form.errors.import_id" class="text-sm text-red-600">
                                    {{ form.errors.import_id }}
                                </p>
                                <p v-if="selectedImport" class="text-sm text-gray-600 dark:text-gray-400">
                                    {{ selectedImport.valid_rows }} valid recipients will receive this message
                                </p>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    rows="6"
                                />
                                <p v-if="form.errors.message_template" class="text-sm text-red-600">
                            ...
                            <div class="space-y-4 rounded-md border border-gray-200 p-4 dark:border-gray-700">
                                ...
                                <div class="grid gap-4 sm:grid-cols-2">
                                    ...
                                    <div class="space-y-2">
                                        <Label for="delay_seconds">Delay Between Messages (seconds)</Label>
                                        <Input
                                            id="delay_seconds"
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-6 space-y-4">
                        <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-950">
                            ...
                            >
                                <p
                                    class="whitespace-pre-wrap text-sm text-gray-900 dark:text-gray-100"
